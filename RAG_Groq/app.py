...
if "vector" not in st.session_state:
    ...
    #First 50 documents are taken for vectorization to reduce the time taken for vectorization. You can increase this number based on your requirements and computational resources.
